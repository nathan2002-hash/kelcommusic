            ...
            <div class="row">
                <div class="col">
                    <div class="home_content text-center">
                        <div class="home_title"><h1>No Geh - Nichol Trahx ft Born Stanner
                        </h1></div>
                        <div class="home_subtitle text-center">04 December, 2020</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="episode_image_container">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <!-- Episode Image -->
                    <div class="episode_image"><img src="{{ asset('images/lj.jpg') }}" alt=""></div>
                </div>
            </div>
        </div>
    </div>
