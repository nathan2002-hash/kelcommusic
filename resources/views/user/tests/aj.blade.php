                        ...
                        <div class="player_content">
                            ...
                            <div class="show_info d-flex flex-row align-items-start justify-content-start">
                                <div class="show_comments">
                                    <a href="/download/music/Aj Coaster_Energy_[Prod By XB3ats].mp3">
                                    ...
                                    <div class="show_comments">
                                        <a href="#">
                                            <div class="d-flex flex-row align-items-center justify-content-start">
                                                <div class="show_comments_icon show_info_icon"><img class="svg" src="{{ asset('images/download.png') }}" alt=""></div>
                                                <div class="show_comments_count">I.P.N.G Music</div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
    ...
    <div class="episode_image_container">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <!-- Episode Image -->
                    <div class="episode_image"><img src="{{ asset('images/costar.jpg') }}" alt=""></div>
                </div>
            </div>
        </div>
    </div>
