            ...
            <div class="row">
                <div class="col">
                    <div class="home_content text-center">
                        <div class="home_title"><h1>Slazenga - Bizmack
                        </h1></div>
                        <div class="home_subtitle text-center">21 May, 2021</div>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="show_info d-flex flex-row align-items-start justify-content-start">
                                ...
                                <div class="show_comments">
                                    <a href="#">
                                        <div class="d-flex flex-row align-items-center justify-content-start">
                                            <div class="show_comments_icon show_info_icon"><img class="svg" src="{{ asset('images/download.png') }}" alt=""></div>
                                            <div class="show_comments_count">Lusaka City Studio</div>
                                        </div>
                                    </a>
                                </div>
                               {{-- @if ($music->video_id)
    ...
    <div class="episode_image_container">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <!-- Episode Image -->
                    <div class="episode_image"><img src="{{ asset('images/episode_1.jpg') }}" alt=""></div>
                </div>
            </div>
        </div>
    </div>
