        ...
        <div class="row">
            ...
            <div class="col-lg-9 episode_col order-lg-2 order-1">
                ...
                <div class="comment_form_container">
                    ...
                    <form action="/adminalbumstore" method="POST" enctype="multipart/form-data" class="comment_form">
                        @csrf
                        ...
                        <div><input type="text" name="album" class="comment_input" placeholder="Album Name"></div>
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" name="number" class="comment_input" placeholder="Number of Songs">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="year" class="comment_input" placeholder="Year" required="required">
                            </div>
                        </div>
                        <div><textarea class="comment_input comment_textarea" name="words" placeholder="Message"></textarea></div>
                        <div class="col-md-12">
                            <input type="file" name="image" class="comment_input" placeholder="Image">
                        </div>
                        <button type="submit" class="comment_button button_fill">Add</button>
                    </form>
                </div>
            </div>
        </div>
