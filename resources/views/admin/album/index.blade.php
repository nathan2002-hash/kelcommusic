            ...
            <div class="col-lg-9 episodes_col">
                ...
                <div class="episodes_container">
                    ...
                    <div class="episode d-flex flex-row align-items-start justify-content-start s1">
                            ...
                            <div class="episode_image">
                                ...
                                <div class="tags">
                                    <ul class="d-flex flex-row align-items-start justify-content-start">
                                        <li><a href="/music/download/{{ $album->id }}">music</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="episode_content">
                            <div class="episode_name"><a href="/adminalbumshow{{ $album->id }}"> {{ $album->album }}
                            </a></div>
                            <div class="episode_date"><a href="/adminalbumshow{{ $album->id }}">{{ $album->year }} Album, {{ $album->username }}
                            </a></div>
                        ...
                        <div class="tags">
                            <ul class="d-flex flex-row align-items-start justify-content-start">
                                <li><a href="/adminmusicedit{{ $album->id }}">Edit Track</a></li>
                                <li>
                                    <form action="{{ url('/adminmusicdelete'.$album->id) }}" method="POST">
                                    {{ method_field('DELETE') }}
                                    {{ csrf_field() }}
