            ...
            <div class="row">
                <div class="col">
                    <div class="home_content text-center">
                        <div class="home_title"><h1>Add an artist at kelcom music</h1></div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 episode_col order-lg-2 order-1">
                ...
                <div class="comment_form_container">
                    ...
                    <form action="/adminartiststore" method="POST" enctype="multipart/form-data" class="comment_form">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" name="fname" class="comment_input" placeholder="First Name">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="lname" class="comment_input" placeholder="Last Name">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" name="username" class="comment_input" placeholder="Username">
                            </div>
                            <div class="col-md-6">
                                <input type="email" name="email" class="comment_input" placeholder="Email">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <input type="text" name="phone" class="comment_input" placeholder="Phone">
                            </div>
                            <div class="col-md-4">
                                <input type="text" name="gender" class="comment_input" placeholder="Gender">
                            </div>
                            <div class="col-md-4">
                                <input type="date" name="dob" class="comment_input" placeholder="Date Of Birth">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" name="country" class="comment_input" placeholder="Country">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="city" class="comment_input" placeholder="City">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <input type="text" name="address" class="comment_input" placeholder="Address">
                            </div>
                            <div class="col-md-4">
                                <input type="text" name="state" class="comment_input" placeholder="State">
                            </div>
                            <div class="col-md-4">
