            ...
            <div class="row">
                <div class="col">
                    <div class="home_content text-center">
                        <div class="home_title"><h1>Upload Video</h1></div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 episode_col order-lg-2 order-1">
                ...
                <div class="comment_form_container">
                    ...
                    <form action="/adminvideostore" method="POST" enctype="multipart/form-data" class="comment_form">
                        @csrf
                        ...
                        <div><input type="text" name="username" class="comment_input" placeholder="Username"></div>
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" name="featuring" class="comment_input" placeholder="Featuring">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                             <input type="number" name="image" class="comment_input" placeholder="Message">
                        </div>
                        <div class="col-md-12">
