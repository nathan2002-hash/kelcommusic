        ...
        <div class="row">
            ...
            <div class="col-lg-9 episode_col order-lg-2 order-1">
                ...
                <div class="comment_form_container">
                    ...
                    <form action="/adminvotestore" method="POST" enctype="multipart/form-data" class="comment_form">
                        @csrf
                        <div><input type="text" name="artist" class="comment_input" placeholder="Artist"></div>
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" name="votes" class="comment_input" placeholder="votes" required="required">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <input type="text" name="image" class="comment_input" placeholder="Image">
                        </div>
                        <button class="comment_button button_fill">Register</button>
                    </form>
                </div>
            </div>
        </div>
