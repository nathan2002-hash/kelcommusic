            ...
            <div class="row">
                <div class="col">
                    <div class="home_content text-center">
                        <div class="home_title"><h1>Edit a biography at kelcom music</h1></div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 episode_col order-lg-2 order-1">
                ...
                <div class="comment_form_container">
                    ...
                    <form action="/admin/biography/{{ $bio->id }}" method="POST" enctype="multipart/form-data" class="comment_form">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" name="artist" value="{{ $bio->artist }}" class="comment_input" placeholder="Artist" required>
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="title" value="{{ $bio->title }}" class="comment_input" placeholder="Title" required="required">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <input type="number" name="day" value="{{ $bio->day }}" class="comment_input" placeholder="Day" required="required">
                            </div>
                            <div class="col-md-4">
                                <input type="text" name="month" value="{{ $bio->month }}" class="comment_input" placeholder="Month" required="required">
                            </div>
                            <div class="col-md-4">
                                <input type="number" name="year" value="{{ $bio->year }}" class="comment_input" placeholder="Year" required="required">
                            </div>
                        </div>
