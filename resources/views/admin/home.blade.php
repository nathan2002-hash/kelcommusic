            ...
            <div class="row">
                <div class="col">
                    <div class="home_content">
                        <div class="home_title"><h1>{{ Auth::user()->name }} Welcome to the Admin Panel At Kelcom Music.</h1></div>
...
<!-- Shows -->
        ...
        <div class="row">
            <div class="col text-center">
                <div class="button_fill shows_button"><a href="">{{ Auth::user()->name }}</a></div>
            </div>
        </div>
    </div>
</div>
