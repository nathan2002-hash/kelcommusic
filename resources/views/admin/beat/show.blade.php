            ...
            <div class="row">
                <div class="col">
                    <div class="home_content text-center">
                        <div class="home_title"><h1>{{ $beat->title }} - {{ $beat->username }}
                        </h1></div>
                        ...
                        <div class="player_content">
                            ...
                            <div class="show_info d-flex flex-row align-items-start justify-content-start">
                                <div class="show_comments">
                                    <a href="/adminbeatdownload{{ $beat->music }}">
    ...
    <div class="episode_image_container">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <!-- Episode Image -->
                    <div class="episode_image"><img src="{{ asset('uploads/music/image/' . $beat->image) }}" alt=""></div>
                </div>
            </div>
        </div>
    </div>
