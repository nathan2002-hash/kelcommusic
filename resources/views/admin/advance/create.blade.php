            ...
            <div class="row">
                <div class="col">
                    <div class="home_content text-center">
                        <div class="home_title"><h1>Add a Advance at kelcom music</h1></div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 episode_col order-lg-2 order-1">
                ...
                <div class="comment_form_container">
                    ...
                    <form action="/adminadvancestore" method="POST" enctype="multipart/form-data" class="comment_form">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" name="artist" class="comment_input" placeholder="Artist" required>
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="title" class="comment_input" placeholder="Title" required="required">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" name="facebook" class="comment_input" placeholder="Facebook">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="twitter" class="comment_input" placeholder="Twitter">
                            </div>
                        </div>
